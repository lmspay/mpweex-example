<template>
  <scroller class="body">
    <panel title="auto-play" type="primary">
      <panel title="auto-play = false" padding-body="0" type="tip">
      ...
      <panel title="auto-play = true" padding-body="0" type="tip">
        <slider class="slider" append="tree"
    ...
    <panel title="Indicator" type="primary">
      <panel title="default style" padding-body="0" type="tip">
        <slider class="slider" append="tree"
          :interval="sliders[0].interval"
          :autoPlay="sliders[0].autoPlay"
          @change="handleSliderChange">
      ...
      <panel title="width & height" padding-body="0" type="tip">
        <slider class="slider" append="tree"
          :interval="sliders[0].interval"
          :autoPlay="sliders[0].autoPlay">
      ...
      <panel title="left & top" padding-body="0" type="tip">
        <slider class="slider" append="tree"
          :interval="sliders[1].interval"
      ...
      <panel title="itemColor & itemSelectedColor" padding-body="0" type="tip">
        <slider class="slider" append="tree"
      ...
      <panel title="itemSize" padding-body="0" type="tip">
        <slider class="slider" append="tree"
          :interval="sliders[1].interval"
          :autoPlay="sliders[1].autoPlay">
