<template>
  <scroller show-scrollbar="false">
    ...
    <panel title="resize" type="primary">
      <tip type="warning" value="resize=stretch(default) 600 x 200" style="margin-bottom: 20px;"></tip>
      ...
      <tip type="warning" value="resize=contain 600 x 200" style="margin-bottom: 20px;"></tip>
      ...
      <tip type="warning" value="resize=cover 600 x 200" style="margin-bottom: 20px;"></tip>
